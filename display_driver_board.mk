...
ifeq ($(DISPLAY_DLKM_ENABLE),  true)
	ifeq ($(call is-board-platform-in-list,$(TARGET_BOARD_PLATFORM)),true)
		...
		BOARD_VENDOR_KERNEL_MODULES += $(KERNEL_MODULES_OUT)/lt9611uxc.ko
		BOARD_VENDOR_RAMDISK_KERNEL_MODULES += $(KERNEL_MODULES_OUT)/lt9611uxc.ko
		BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD += $(KERNEL_MODULES_OUT)/lt9611uxc.ko
	endif
endif
