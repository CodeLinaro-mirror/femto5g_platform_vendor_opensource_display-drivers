...
static const struct hfi_format_map sde_linear_fmt_map[] = {
	...
	{HFI_COLOR_FORMAT_RGB888_BYPASS, DRM_FORMAT_RGB888, DRM_FORMAT_MOD_QCOM_DMA},
	...
	{HFI_COLOR_FORMAT_FSC_R, DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_R |
				DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{HFI_COLOR_FORMAT_FSC_G, DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_G |
				DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{HFI_COLOR_FORMAT_FSC_B, DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_B |
				DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{HFI_COLOR_FORMAT_FSC_ALPHA, DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_FSC_ALPHA |
				DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{HFI_COLOR_FORMAT_Y10, DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX |
			DRM_FORMAT_MOD_QCOM_LUMA_ONLY},
	{HFI_COLOR_FORMAT_Y10_MSB_ALIGN, DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX |
			DRM_FORMAT_MOD_QCOM_LUMA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN},
	{HFI_COLOR_FORMAT_A10, DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX |
			DRM_FORMAT_MOD_QCOM_ALPHA_ONLY},
	{HFI_COLOR_FORMAT_A10_MSB_ALIGN, DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX |
			DRM_FORMAT_MOD_QCOM_ALPHA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN},
	{HFI_COLOR_FORMAT_Y10, DRM_FORMAT_P010, DRM_FORMAT_MOD_QCOM_LUMA_ONLY},
	{HFI_COLOR_FORMAT_Y10_MSB_ALIGN, DRM_FORMAT_P010,
			DRM_FORMAT_MOD_QCOM_LUMA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN},
	{HFI_COLOR_FORMAT_A10, DRM_FORMAT_P010, DRM_FORMAT_MOD_QCOM_ALPHA_ONLY},
	{HFI_COLOR_FORMAT_A10_MSB_ALIGN, DRM_FORMAT_P010,
			DRM_FORMAT_MOD_QCOM_ALPHA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN},
	{HFI_COLOR_FORMAT_Y8, DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DMA},
...
static const struct hfi_format_map sde_non_linear_fmt_map[] = {
	...
	{HFI_COLOR_FORMAT_UBWC_P010, DRM_FORMAT_NV12,
		DRM_FORMAT_MOD_QCOM_COMPRESSED | DRM_FORMAT_MOD_QCOM_DX},
	{HFI_COLOR_FORMAT_UBWC_FSC_R,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_CAC_R | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_FSC_G,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_CAC_G | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_FSC_B,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_CAC_B | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_FSC_R_4R,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_CAC_R | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_FSC_G_4R,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_CAC_G | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_FSC_B_4R,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_CAC_B | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_FSC_ALPHA,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_FSC_ALPHA | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_FSC_ALPHA_4R,  DRM_FORMAT_C8,
		DRM_FORMAT_MOD_QCOM_FSC_ALPHA | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_ABGR_NV12_4R_4Y,  DRM_FORMAT_ABGR8888,
		DRM_FORMAT_MOD_QCOM_NV12_4R_4Y | DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_P210, DRM_FORMAT_P210, DRM_FORMAT_MOD_QCOM_DX},
	{HFI_COLOR_FORMAT_UBWC_P210, DRM_FORMAT_P210, DRM_FORMAT_MOD_QCOM_COMPRESSED |
		DRM_FORMAT_MOD_QCOM_DX},
	{HFI_COLOR_FORMAT_UBWC_Y10, DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX |
			DRM_FORMAT_MOD_QCOM_LUMA_ONLY | DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_A10, DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX |
			DRM_FORMAT_MOD_QCOM_ALPHA_ONLY | DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_Y10, DRM_FORMAT_P010, DRM_FORMAT_MOD_QCOM_LUMA_ONLY |
			 DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{HFI_COLOR_FORMAT_UBWC_A10, DRM_FORMAT_P010, DRM_FORMAT_MOD_QCOM_ALPHA_ONLY |
			 DRM_FORMAT_MOD_QCOM_COMPRESSED},
};
...
u32 hfi_catalog_get_hfi_format(struct sde_format_extended *sde_fmt)
{
	...
	case DRM_FORMAT_MOD_QCOM_LUMA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN:
	case DRM_FORMAT_MOD_QCOM_ALPHA_ONLY:
	case DRM_FORMAT_MOD_QCOM_ALPHA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN:
	case DRM_FORMAT_MOD_QCOM_DX|DRM_FORMAT_MOD_QCOM_LUMA_ONLY:
	case DRM_FORMAT_MOD_QCOM_DX|DRM_FORMAT_MOD_QCOM_LUMA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN:
	case DRM_FORMAT_MOD_QCOM_DX|DRM_FORMAT_MOD_QCOM_ALPHA_ONLY:
	case DRM_FORMAT_MOD_QCOM_DX|DRM_FORMAT_MOD_QCOM_ALPHA_ONLY|DRM_FORMAT_MOD_QCOM_MSB_ALIGN:
