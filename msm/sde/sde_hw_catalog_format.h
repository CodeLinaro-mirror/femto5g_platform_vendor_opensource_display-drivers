...
#define A10_Y10_FMTS {DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX | \
		DRM_FORMAT_MOD_QCOM_LUMA_ONLY}, \
	{DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX | DRM_FORMAT_MOD_QCOM_LUMA_ONLY | \
		DRM_FORMAT_MOD_QCOM_MSB_ALIGN}, \
	{DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX | DRM_FORMAT_MOD_QCOM_LUMA_ONLY | \
		DRM_FORMAT_MOD_QCOM_COMPRESSED}, \
	{DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX | DRM_FORMAT_MOD_QCOM_ALPHA_ONLY}, \
	{DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX | DRM_FORMAT_MOD_QCOM_ALPHA_ONLY | \
		DRM_FORMAT_MOD_QCOM_MSB_ALIGN}, \
	{DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_DX | DRM_FORMAT_MOD_QCOM_ALPHA_ONLY | \
		DRM_FORMAT_MOD_QCOM_COMPRESSED}
...
static const struct sde_format_extended plane_formats[] = {
	RGB_FMTS,
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_R | DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_G | DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_B | DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_FSC_ALPHA | DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_R | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_G | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	...
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_FSC_ALPHA | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_R | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_G | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_B | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_FSC_ALPHA | DRM_FORMAT_MOD_QCOM_FSC_4R_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
...
/* DMA pipe formats for platforms without UBWC/10-bit support (e.g. shikra/scuba) */
static const struct sde_format_extended plane_formats_dma_no_ubwc[] = {
...
/* VIG pipe formats for platforms without UBWC/YUV/10-bit support (e.g. shikra/scuba) */
static const struct sde_format_extended plane_formats_vig_no_ubwc_csc[] = {
	{DRM_FORMAT_ARGB8888, 0},
	{DRM_FORMAT_ABGR8888, 0},
	{DRM_FORMAT_RGBA8888, 0},
	{DRM_FORMAT_BGRA8888, 0},
...
static const struct sde_format_extended plane_csc_formats[] = {
	{DRM_FORMAT_NV12, DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_NV12, 0},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_FSC_ALPHA | DRM_FORMAT_MOD_QCOM_FSC_TILE},
	{0, 0},
...
static const struct sde_format_extended plane_repro_formats[] = {
	{DRM_FORMAT_RGB888, 0},
	{DRM_FORMAT_ABGR8888, DRM_FORMAT_MOD_QCOM_NV12_4R_4Y | DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_ABGR8888, DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_R | DRM_FORMAT_MOD_QCOM_FSC_TILE |
...
static const struct sde_format_extended wb_csc_formats[] = {
	{DRM_FORMAT_ABGR8888, DRM_FORMAT_MOD_QCOM_NV12_4R_4Y | DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{0, 0},
};

static const struct sde_format_extended wb_repro_formats[] = {
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_R | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
	{DRM_FORMAT_C8, DRM_FORMAT_MOD_QCOM_CAC_G | DRM_FORMAT_MOD_QCOM_FSC_TILE |
		DRM_FORMAT_MOD_QCOM_COMPRESSED},
