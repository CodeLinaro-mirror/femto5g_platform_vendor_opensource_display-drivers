...
static struct sde_prop_type roi_misr_prop[] = {
	...
	{ROI_MISR_ENABLE, "qcom,sde-has-roi-misr", false, PROP_TYPE_BOOL},
	{ROI_MISR_MISMATCH_IRQ, "qcom,sde-misr-mismatch-irq", false, PROP_TYPE_BOOL},
};
		...
		struct sde_mdss_cfg *sde_cfg)
{
	...
	sde_cfg->has_roi_misr =
		PROP_VALUE_ACCESS(prop_value, ROI_MISR_ENABLE, 0);

	sde_cfg->misr_mismatch_irq =
		PROP_VALUE_ACCESS(prop_value, ROI_MISR_MISMATCH_IRQ, 0);
