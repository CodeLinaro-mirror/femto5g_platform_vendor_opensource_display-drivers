...
enum sde_format_flags {
	...
	SDE_FORMAT_FLAG_LUMA_ONLY_BIT,
	SDE_FORMAT_FLAG_ALPHA_ONLY_BIT,
...
#define SDE_FORMAT_FLAG_LUMA_ONLY	BIT(SDE_FORMAT_FLAG_LUMA_ONLY_BIT)
#define SDE_FORMAT_FLAG_ALPHA_ONLY	BIT(SDE_FORMAT_FLAG_ALPHA_ONLY_BIT)
...
#define SDE_FORMAT_IS_LUMA10(X) (test_bit(SDE_FORMAT_FLAG_LUMA_ONLY_BIT, (X)->flag))
#define SDE_FORMAT_IS_ALPHA10(X) (test_bit(SDE_FORMAT_FLAG_ALPHA_ONLY_BIT, (X)->flag))
