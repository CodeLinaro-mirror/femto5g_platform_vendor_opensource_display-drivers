...
static struct privacy_area_reg1_on privacy_area_reg1_on_v2 = {
	.cmd0   = {0xf0, 0x5a, 0x5a},
	.cmd1   = {0xb0, 0x00, 0x05, 0x66},
	.cmd2   = {0x66, 0x00, 0x0a, 0x00, 0x0a},
	.cmd3   = {0xb0, 0x00, 0x1a, 0x66},
	.cmd4   = {0x66, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	.cmd5   = {0xb0, 0x00, 0x3b, 0x66},
	.cmd6   = {0x66, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	.cmd7   = {0xf0, 0xa5, 0xa5},
};

struct privacy_area_reg1_off {
	u8 cmd0[3];
	u8 cmd1[4];
	u8 cmd2[5];
	u8 cmd3[4];
...
static struct privacy_area_reg1_off privacy_area_reg1_off_v2 = {
	.cmd0   = {0xf0, 0x5a, 0x5a},
	.cmd1   = {0xb0, 0x00, 0x05, 0x66},
	.cmd2   = {0x66, 0x00, 0x0a, 0x00, 0x0a},
	.cmd3   = {0xb0, 0x00, 0x1a, 0x66},
	.cmd4   = {0x66, 0x00},
	.cmd5   = {0xb0, 0x00, 0x3a, 0x66},
	.cmd6   = {0x66, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	.cmd7   = {0xf0, 0xa5, 0xa5},
};

struct privacy_area_reg2_on {
	u8 cmd0[3];
	u8 cmd1[4];
	u8 cmd2[5];
	u8 cmd3[4];
...
static struct privacy_area_reg2_on privacy_area_reg2_on_v2 = {
	.cmd0   = {0xf0, 0x5a, 0x5a},
	.cmd1   = {0xb0, 0x00, 0x05, 0x66},
	.cmd2   = {0x66, 0x00, 0x0a, 0x00, 0x0a},
	.cmd3   = {0xb0, 0x00, 0x2a, 0x66},
	.cmd4   = {0x66, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	.cmd5   = {0xb0, 0x00, 0x3a, 0x66},
	.cmd6   = {0x66, 0x01},
	.cmd7   = {0xf0, 0xa5, 0xa5},
...
static struct privacy_area_reg2_off privacy_area_reg2_off_v2 = {
	.cmd0   = {0xf0, 0x5a, 0x5a},
	.cmd1   = {0xb0, 0x00, 0x05, 0x66},
	.cmd2   = {0x66, 0x00, 0x0a, 0x00, 0x0a},
	.cmd3   = {0xb0, 0x00, 0x2a, 0x66},
